...
(function (window, document) {
  ...
  var MSG = {
    default: {
      morning: 'Dobré ráno, jsem asistentka školy. S čím vám mohu pomoci?',
      day: 'Dobrý den, jsem asistentka školy. S čím vám mohu pomoci?',
      night: 'Dobrý večer, jsem asistentka školy. S čím vám mohu pomoci?'
    },
    deep: {
    ...
    return_short: {
      morning: 'Máte ještě nějaký další dotaz? Ráda vám s ním pomohu.',
      day: 'Máte ještě nějaký další dotaz? Ráda vám s ním pomohu.',
      night: 'Máte ještě nějaký další dotaz? Ráda vám s ním pomohu.'
    },
    return_medium: {
...
:root{
  --magichill-primary:#E5097A;
  --magichill-primary-hover:#89054C;
  --magichill-border:#EFEFEF;
...
@media (max-width:480px){
  ...
  function injectCTA() {
    ...
    wrap.innerHTML = [
      ...
      '      <img class="magichill-avatar" src="https://trixtecheu.github.io/MAGICHILL/images/magichill-icon-hilly.jpg" alt="Hilly" draggable="false" ondragstart="return false;">',
      '      <strong class="magichill-title"><span class="magichill-title-accent">AI asistentka</span><span class="magichill-title-rest">Hilly</span></strong>',
      '    </div>',
      '    <p class="magichill-desc" id="magichill-text">' + defaultMsg + '</p>',
      '    <button id="magichill-open" class="magichill-btn" aria-label="Otevřít AI asistentku Hilly"><span class="magichill-label">Poraď mi</span></button>',
      '  </div>',
      '</div>'
    ].join('\n');
